...
insert into Barley(id, varieMaltty) values (1,'Maris Otter Pale Malt');
...
insert into AdditiveIngredient values (id, quantity,additive_id) values (1,2,1);
...
insert into Recipe_AdditiveIngredient (Recipe_id,barlies_id) values (1,1);
